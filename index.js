  ...
  wiegine.login(cookieContent, {}, (err, api) => {
    ...
    if (event.mentions && Object.keys(event.mentions).includes(botConfig.adminID)) {
      const adminTagReplies = [
        "अबे चम्पू! मेरे माफिया को टैग मत कर 😈",
        "एक बार में समझ नहीं आता क्या? माफिया को टैग मत करो 😒",
        "तुझे दिख नहीं रहा माफिया बिज़ी है 🧐😈",
        "अरे हमारे माफिया सो रहे हैं, उन्हें टैग करके परेशान मत करो 😴",
        "प्लीज़ मेरे माफिया को टैग मत करो, वो बहुत थके हुए हैं 😈",
        "हाँ जानू मैं इधर ही हूँ 😘 लेकिन माफिया को मत बुलाओ",
        "जा बे! मेरे माफिया को मत बुला, वो सो रहे हैं 🐧🎧",
        "अबे माफिया सो रहा है, परेशान मत कर उसे 🐧🎧✨",
        "माफिया अभी बिज़ी है 🎧🤍",
        "हाँ बोलो क्या काम है माफिया से 😛🤍",
        "अबे निकल यहां से! माफिया को बार-बार मत बुला 😈",
        "फिर से माफिया को टैग कर दिया उल्लू के पट्ठे 😈"
      ];
